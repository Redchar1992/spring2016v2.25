			...
			if (file) {
				...
				reader.onload = function(e) {
					html = html + '<div id="uploadList_'+ i +'" class="upload_append_list"><p><strong>' + file.name + '</strong>'+
						'<a href="javascript:" class="upload_delete" title="删除" onclick="del()" data-index="'+ i +'">删除</a><br />' +
						'<img id="uploadImage_' + i + '" src="' + e.target.result + '" class="upload_image resize-image" draggable="true" style="width:'+w+'px;display:none"/></p>'+
